...
- [x] **Step 3: Implement the minimum Windows observer**
...
- [x] **Step 4: Enforce background policy**
...
- [x] **Step 3: Implement registry and generated configuration**
...
- [x] **Step 2: Implement one executor boundary**
...
- [x] **Step 3: Replace preview-only UI**
...
- [x] **Step 2: Implement bounded embedding client**
...
- [x] **Step 3: Implement hybrid commands**
...
- [x] **Step 4: Enable Related honestly**
...
- [x] **Step 1: Write failing manifest/security tests**
...
- [x] **Step 2: Implement downloader and verifier**
...
- [x] **Step 1: Add failing aggregation/sanitization tests**
...
- [x] **Step 2: Aggregate native status**
...
- [x] **Step 4: Run packaged smoke and inspect evidence**
